...
int main(){
    char path[500] = "/home/ana/PhD/Project_2/Data/two_months1";
//    char path[300] = "/home/ana/PhD/Project/Data/traj";
    // char path[300] = "/home/ana/PhD/beta/air_750_beta_p90_100";
    read_trajectories(path);
//    clear_trajs();
    //read_trajectories(path);
    //printTrajectory(10);
    //printt( 1,"AIR_TEMP");
    //read_data("/home/ana/PhD/Project/Data/Meteo/pm10_tetouan.csv","yes");
    read_data("/home/ana/PhD/Project_2/Data/Meteo/Alpha_beta_meteo_Santander.csv","yes");
    get_index_data_headers("Inicio_Recogida","date_begin");
    date_format("begin","MM/DD/YYYY HH:mm:ss");
//    data_copy();
    get_index_data_headers("Fin_Recogida","date_end");
    date_format("end","MM/DD/YYYY HH:mm:ss");
    //datamonthly_average(2);
//    data_copy();
    //date_format("Inicio_Recogida_Granada","DD/MM/YYYY HH:mm:ss");
	//date_format("Fin_Recogida_Granada","DD/MM/YYYY HH:mm:ss");
	//concentration_trajectories("Inicio_Recogida_Granada", "Actividad_Beta_Granada","2017-12-20");
    get_index_data_headers("Actividad_Alpha (10-5 Bq/m3)","concentration");
    ctr_trajs(-5);
////    data_for_trajstat();
	//data_to_trajstat();
    // correlation(-80,20,10,80,2,"AIR_TEMP");
    //CWT_3D(-80,30,10,80,0.5,"500;1000;3000");
//    CWT_3D(-80,30,10,80,0.5,"500;1000;3000");
//    WCWT_3D("0.8;0.4;0.05:0.8;0.4;0.05:0.8;0.4;0.05", "30,10,5:30,10,5:30,10,5", -80, 10, 5, "endpoints");
	//WCWT_3D("0.7;0.42;0.05:0.8;0.2;0.05:0.9;0.4;0.1", "20;10;5:18;7;3:15;8;2", -80, 10, 5, "endpoints");
    ///CWT_3D(-80,20,10,80,0.5,"90000");
	///WCWT_3D("0.7;0.42;0.05:0.8;0.2;0.05", "20;10;5:18;7;3", -80, 10, 0.5, "endpoints");
///    CWT(-80,20,20,80,0.5);
///    WCWT("0.7;0.4;0.1","20;10;5", -80, 20, 0.5, "endpoints");
//    PSCF_3D(-80, 20, 10, 80, 0.5,"90000",0.003);
//   WPSCF_3D("0.7;0.42;0.05:0.8;0.2;0.05","20;10;5:18;7;3",-80, 10, 0.5, "endpoints");*/
///    PSCF(-80, 20, 20, 80, 0.5, 0.00496);
///    WPSCF("0.7;0.4;0.1","20;10;5", -80, 20, 0.5, "endpoints");
    //PSCF_3D(-80,20,20,80,1,"1000;3000",0.0037);
    //WPSCF_3D("0.7;0.42;0.05:0.8;0.2;0.05:0.9;0.4;0.1", "20;10;5:18;7;3:15;8;2", -80, 20,1,"endpoints");
    //select_trajs_ctr(0, 0.229 ,"/home/ana/PhD/beta/air_3000_beta_p0_10");
    //concentration_trajectories("Fecha","Be7");
	//printTrajectory(4224);
	//printallTrajectories();
	//display_data();
	//CWT(-80,30,10,80,0.5);
	//WCWT("0.7;0.42;0.05","20;10;5",-80,10,5,"endpoints");
	//showCWT();
	//PSCF(-80,30,10,80,1,0,"endpoints");
//	clustering_TSV(4,1);
   //clustering_kmean(30,30,1,6);
    clustering_kmean(30,30,1,3);
    open_clustering("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    variation_TSV("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    choice_the_number_of_clusters(4,"kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    fill_clusters_names("A;Z;E;R");
    
    add_clusters_to_data_file("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    clusters_monthly_frequency("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    fill_group_names("2;2.5;3;4");
    add_groups_to_data_file("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
    extract_clusters_roseplot_file ("kmean", "/home/ana/PhD/Project_2/Results/Cluster/clustering1_3");
...
/*
    ...
    // clustering_kmean(60,60,1);
    //open_clustering("kmean");
    // variation_TSV("kmean");
    // choice_the_number_of_clusters(4,"kmean");
    
    /*fill_clusters_names("A;Z;E;R");
    //extract_roseplot_file ("Inicio_Recogida","Fin_Recogida","Actividad_Alpha (10-5 Bq/m3)",4,"0.0649;0.09577;0.14600;0.22775;0.354", "C");
    add_clusters_to_data_file("kmean");
    clusters_monthly_frequency("kmean");
    
    
    fill_group_names("3;4;5;6;8");
    add_groups_to_data_file("kmean");
    extract_clusters_roseplot_file ("kmean");*/

//    freq_hysplit(5,"/home/ana/PhD/Project/Data/clustlist/Beta/750m/clustering_Beta_750m_P90_P100");
    //extract_file_data("Inicio_Recogida","Fin_Recogida","Actividad_Alpha (10-5 Bq/m3)","../Results/Correlation",5,0.801,10001,"cluster","corr__Beta_750m_P90_P100");
    //extract_file_data(, , , std::string path, int nbr_clusters, double min, double max, std::string header,std::string file)
